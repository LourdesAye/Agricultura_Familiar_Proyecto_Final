...
val current_loan = Loan("Usuario1", listOf<Item>(Item("Tomate", 1, "KG")), emptyList(), 0.0)
@Composable
...
@Composable
fun LoanInfoScreen(navController: NavController){
    Column(modifier = Modifier
        ...
        Box (modifier = Modifier.fillMaxWidth()){
            ...
            Text(
                ...
                fontSize = 20.sp,
                textAlign = TextAlign.Center,
                modifier = Modifier.padding(top=50.dp, bottom = 10.dp).align(Alignment.CenterEnd)
            )
        }
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            Button(
                onClick = {
                    navController.navigate("loan/edit")
                },
