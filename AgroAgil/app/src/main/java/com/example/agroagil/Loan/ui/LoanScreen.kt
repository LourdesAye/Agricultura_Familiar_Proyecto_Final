...
var clickPagadoParcialmente = mutableStateOf(false)
var colorPagadoParcialmente = mutableStateOf<Color>(Color(0))
...
fun filterStatus(){
    Row(
        ...
        if (clickPagadoParcialmente.value){
            colorPagadoParcialmente.value = Color(PagadoParcialmenteClick.toColorInt())
        }else{
            colorPagadoParcialmente.value=Color(MaterialTheme.colorScheme.background.value)
        }
        Card(
            onClick={
                clickPagadoParcialmente.value = !clickPagadoParcialmente.value
                if(clickPagadoParcialmente.value){
            ...
            modifier = Modifier
                ...
                .height(50.dp),
            border = BorderStroke(1.dp, MaterialTheme.colorScheme.inverseOnSurface),
        colors = CardDefaults.cardColors(colorPagadoParcialmente.value)
        ) {
            Row() {
                Column(
                    modifier = Modifier
